...
const HeroSection = () => {
  ...
  const socialLinks = [
    ...
    { icon: Linkedin, href: "https://www.linkedin.com/in/liril-chandrawanshi-a087aa1aa/", label: "LinkedIn" },
      ...
      <div className="container mx-auto px-6 z-10">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-center justify-center gap-8 sm:gap-12 mb-12 mt-8 sm:mt-0">
            ...
            <div className="text-center lg:text-left flex-1 max-w-2xl flex flex-col justify-center">
              {/* Greeting */}
              <div className="mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                ...
                >
                  <a
                    href="https://drive.google.com/file/d/13nYFQ5PVuZchJMYaHN3M7ocS5ooWDVUf/view?usp=sharing"
                    target="_blank"
